...
namespace DTO_QLSV
{
    public class DTO_SinhVien
    {
        ...
        public string SinhVien_MaSinhVien { get => _SinhVien_MaSinhVien; set => _SinhVien_MaSinhVien = value; }
        public string SinhVien_HoTen { get => _SinhVien_HoTen; set => _SinhVien_HoTen = value; }
        public string SinhVien_QueQuan { get => _SinhVien_QueQuan; set => _SinhVien_QueQuan = value; }
        public string SinhVien_NgaySinh { get => _SinhVien_NgaySinh; set => _SinhVien_NgaySinh = value; }
        public string SinhVien_NoiSinh { get => _SinhVien_NoiSinh; set => _SinhVien_NoiSinh = value; }
        public string SinhVien_GioiTinh { get => _SinhVien_GioiTinh; set => _SinhVien_GioiTinh = value; }
        public string SinhVien_Hinh { get => _SinhVien_Hinh; set => _SinhVien_Hinh = value; }
        public string SinhVien_MaNganh { get => _SinhVien_MaNganh; set => _SinhVien_MaNganh = value; }
